...
feature 'Admin - Product Stock Management', js: true do
  ...
  before do
    ...
    @product.add_experience! @experience1
  end
  ...
  context 'as Admin' do
    ...
    scenario 'should display all existing stock item locations' do
      ...
      within '.stock_location_info' do
        page.should have_content(@experience1.name)
        # Stock item doesn't exist
        page.should_not have_content(@experience2.name)
      end
    end
  ...
  context 'as Experience' do
    ...
    scenario 'should only display experiences stock locations' do
      visit spree.stock_admin_product_path(@product)
    ...
    scenario "can delete an existing stock location", js: true do
      create(:stock_location, experience: @user.experience)
      visit current_path
